  ...
  ({ className, withValue = false, ...props }, ref) => (
    <div className={cn("flex items-center gap-3", withValue && "w-full")}>
      ...
      >
        ...
        <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-brand/70 bg-white shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand" />
      </SliderPrimitive.Root>
      {withValue && (
